    ...
    <div class="row mt-5">
        ...
        <div class="col-6">
            ...
            <form method="POST" action="cadastrarEmpresa">
                <div class="form-group">
                    <label class="form-check-label" for="cadastroCpf">Código</label>
                    <input class="form-control" id="cadastroCpf" type="text" placeholder="Código" name="codigo">
                </div>
        ...
        <div class="col-12 align-content-center">
            <a href="loginCandidato" class="btn btn-primary">É um candidato? Clique aqui!</a>
        </div>
    </div>
</div>
</body>
